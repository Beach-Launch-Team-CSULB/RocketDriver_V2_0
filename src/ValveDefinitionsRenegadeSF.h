...
Valve HiPressVent{17, 2, NormalClosed, 6, 25000, false};
Valve LoxMV{24, 2, NormalClosed, 8, 25000, false, 50};
Valve FuelMV{25, 2, NormalClosed, 5, 25000, false, 50};
// On Renegade SF Prop Node
Valve LoxVent{18, 3, NormalOpen, 1, 500000, false, 50};
Valve LoxDomeReg{19, 3, NormalClosed, 2, 25000, false};
Valve LoxDomeRegVent{20, 3, NormalClosed, 6, 25000, false};
Valve FuelVent{21, 3, NormalClosed, 4, 25000, false};
Valve FuelDomeReg{22, 3, NormalClosed, 3, 25000, false};
