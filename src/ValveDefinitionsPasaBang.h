...
Valve LoxMV{24, 8, NormalClosed, ALARA_HIGHPOWER_PWMOUT8, ALARA_HIGHPOWER_DIGITALOUT8, 25000, false, ValveState::CloseCommanded, 50};
Valve FuelMV{25, 8, NormalClosed, ALARA_HIGHPOWER_PWMOUT5, ALARA_HIGHPOWER_DIGITALOUT5, 25000, false, ValveState::CloseCommanded, 50};
Valve LoxVent{18, 8, NormalOpen, ALARA_HIGHPOWER_PWMOUT1, ALARA_HIGHPOWER_DIGITALOUT1, 500000, false, ValveState::CloseCommanded, 166}; // don't actually want the abort state here but need to change constructor
