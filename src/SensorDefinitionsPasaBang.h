...
EXT_SENSOR ChamberPT1{56, 8, ALARA_ANALOG_IN4, &waterGoesVroom, 10, 100, 8000, 0.0185, -128.88};                 // 7
EXT_SENSOR FuelLinePT{58, 8, ALARA_ANALOG_IN5, &waterGoesVroom, 2, 10, 1000, 0.0185, -125.74};          // 8
EXT_SENSOR LoxLinePT{60, 8, ALARA_ANALOG_IN6, &waterGoesVroom, 2, 10, 1000, 0.0186, -128.58};           // 10
//EXT_SENSOR MVPneumaticsPT{78, 3, A15, 2, 10, 50, false, 0.0186, -126.56};                // 11
EXT_SENSOR FuelTankPT1{62, 8, ALARA_ANALOG_IN7, &waterGoesVroom, 2, 10, 6000, 0.0186, -129.3};                    // 14
EXT_SENSOR FuelTankPT2{64, 8, ALARA_ANALOG_IN8, &waterGoesVroom, 2, 10, 6000, 0.0123, -123.11};                    // 14
EXT_SENSOR LoxTankPT1{66, 8, ALARA_ANALOG_IN2, &waterGoesVroom, 2, 10, 6000, 0.0187, -125.36};                    // 15
EXT_SENSOR LoxTankPT2{68, 8, ALARA_ANALOG_IN3, &waterGoesVroom, 2, 10, 6000, 0.0124, -123.43};                    // 15
EXT_SENSOR HiPressPT{70, 8, ALARA_ANALOG_IN1, &waterGoesVroom, 2, 10, 500, 0.0933, -638.38};                 // 16
